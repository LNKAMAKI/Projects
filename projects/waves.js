            ...
            for (current in timers) {
             ...
             for (i = 1; i < contnumber/3;i++) {
                ...
                if (cond == true) {
                       ...
                       // }
                }else if (conts[contnumber/3 + i - 1].running[0] == true && finalperc > tension) {//(((conts[contnumber/3 + i - 1].ys[0])).toFixed(0) == ((conts[contnumber/3 + i - 1].ysfinal[0])).toFixed(0)){
                    if (i == 3) {
               ...
               if (i > 0 && i < (contnumber/3)) {    
                 ...
                 eq = (conts[contnumber/3 + i].ys[current - 1]).toFixed(0) == (conts[contnumber/3 + i].ysfinal[current - 1]).toFixed(0)
                ...
                conts[contnumber/3 + i].go[current - 1] = false
                   ...
                   // if (i == 19 && conts[38].running[current] == true && current == 1 && conts[38].ys[current] != -100) {
                    ...
                    //}
                    //if (i == 4 && (conts[contnumber/3 + i - 1].ys[current]).toFixed(0) == (conts[contnumber/3 + i - 1].ysfinal[current]).toFixed(0)) { // conts[contnumber/3 + i - 1].running[current] == true && finalperc == 1 && current == 2) { 
                    ...
                    //wi == (conts[contnumber/3 + i - 1].ys[current]).toFixed(0) == (conts[contnumber/3 + i - 1].ysfinal[current]).toFixed(0)
                    }else{
                        wi = true
                    }
                    if (add == true && wi == true) {// && (conts[contnumber/3 + i - 1].ys[current]).toFixed(0) == (conts[contnumber/3 + i - 1].ysfinal[current]).toFixed(0)){ //conts[contnumber/3 + i - 1].running[current] == true && finalperc >= 0.5) { //Math.round(finalperc) == 1){//&& (conts[contnumber/3 + i - 1].ys[current]).toFixed(0) == (conts[contnumber/3 + i - 1].ysfinal[current]).toFixed(0)) {//&& (conts[contnumber/3 + i - 1].ys[current]).toFixed(0) == (conts[contnumber/3 + i - 1].ysfinal[current]).toFixed(0)) {//conts[contnumber/3 + i].time[current] != conts[contnumber/3 + i].start[current - 1].time && conts[contnumber/3 + i - 1].ys[current] == conts[contnumber/3 + i - 1].ysfinal[current]){
                       if (i == 19) {
    ...
    for (n = 0; n < timers2.length; n++) {
        for (current = 0; current < timers2[n].length; current++) {
           ...
           if (conts2[n][indirec - 1].running[0] == true && finalperc > tension && conts2[n][indirec].ys[0] == -100) { // && finalperc >= 0.5 && conts2[n][indirec].ys[0] == -100) {
                  ...
                  // }
           }else if (conts2[n][indirec - 1].running[0] == true && finalperc > tension) { // && finalperc >= 0.5) { //(((conts2[n][indirec - 1].ys[0])).toFixed(0) == ((conts2[n][indirec - 1].ysfinal[0])).toFixed(0)){
               if (i == 3) {
          ...
          if (i > 0 && i < contnumber/3) {    
            ...
            eq = (conts2[n][indirec].ys[current - 1]).toFixed(0) == (conts2[n][indirec].ysfinal[current - 1]).toFixed(0)
               ...
               if (conts2[n][indirec - 1].ys[current] != -100) { //conts2[n][indirec - 1].ys[current] != undefined && conts2[n][indirec - 1].ys[current] != -100 && conts2[n][indirec - 1].ysfinal[current] != undefined) {
                ...
                if (i == 19 && conts2[n][indirec - 1].running[current] == true && finalperc > tension && current == 2) {
                    ...
                    if (i > 2) {
                        ...
                        wi = (conts2[n][indirec - 1].ys[current]).toFixed(0) == (conts2[n][indirec - 1].ysfinal[current]).toFixed(0)
                    }
      ...
      /*
        ...
        for (i3 = 1; i3 < (contnumber/3)*2;i3++) {
            ...
            if (conts[r].ys[0] != undefined && conts[r].ysfinal[0] != undefined  && conts[r].ys[1]!= undefined && conts[r].ysfinal[1] != undefined && timers.length > 3) {
                if ((conts[r].ys[0]).toFixed(0) == (conts[r].ysfinal[0]).toFixed(0) && (conts[r].ys[1]).toFixed(0) == (conts[r].ysfinal[1]).toFixed(0)) {
                   timers.shift()
                   tot = tot - 1
                   advances[0].shift()
                   direct.shift()
            ...
            for (t2 = 0; t2 < timers2.length; t2++) {
                ...
                if (conts2[t2][l2].ys[ko] != undefined && conts2[t2][l2].ysfinal[ko] != undefined  && conts2[t2][l2].ys[1] != undefined && conts2[t2][l2].ysfinal[1] != undefined && timers2[t2].length > 3) {
                    ...
                    firstcon = (conts2[t2][l2].ys[ko]).toFixed(0) == (conts2[t2][l2].ysfinal[ko]).toFixed(0) && (conts2[t2][l2].ys[1]).toFixed(0) == (conts2[t2][l2].ysfinal[1]).toFixed(0)
                 if (firstcon == true) {
