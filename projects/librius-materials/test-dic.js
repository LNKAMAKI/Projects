...
contents = [
    ...
    {title:'text-4-train-1', url:'html-logo.svg',subs: [
        ...
        {title: 'put down', type:"phrasal verb",meaning: 'attribute something as the cause of something else_disapprove or criticize_Cease an activity',examples: 'it can also give long-winded replies, a problem its developers put down to trainers preferring longe answers that loook more comprehensive*The increase in crime can be put down to socioeconomic factors_She felt hurt when her peers put her down for her ideas*The rebellion was forcefully put down by the authorities'},
