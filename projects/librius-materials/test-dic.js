...
contents = [
    ...
    {title:'text-1-train-1', url:'html-logo.svg',subs:[
        {title: 'death toll', type:"noun",meaning: '',examples: ''},
        {title: 'strict', type:"noun",meaning: '',examples: ''},
        {title: 'aftermath', type:"noun",meaning: '',examples: ''},
        {title: 'preparedness', type:"noun",meaning: '',examples: ''},
        {title: 'faultline', type:"noun",meaning: '',examples: ''},
        {title: 'overwhelming', type:"noun",meaning: '',examples: ''},
        {title: 'stock market', type:"noun",meaning: '',examples: ''},
        {title: 'aftershock', type:"noun",meaning: '',examples: ''},
        {title: 'amount', type:"noun",meaning: '',examples: ''},
        {title: 'lax', type:"noun",meaning: '',examples: ''},
        {title: 'building code', type:"noun",meaning: '',examples: ''},
        {title: 'reliance', type:"noun",meaning: '',examples: ''},
        {title: 'earthquake-prone', type:"noun",meaning: '',examples: ''},
        {title: 'load-bearing', type:"noun",meaning: '',examples: ''},
        {title: 'rubble in waiting', type:"noun",meaning: '',examples: ''},
        {title: 'cut corners', type:"noun",meaning: '',examples: ''},
        {title: 'address', type:"noun",meaning: '',examples: ''},
        {title: 'due to', type:"noun",meaning: '',examples: ''},
        {title: 'budget', type:"noun",meaning: '',examples: ''},
        {title: 'cash-strapped', type:"noun",meaning: '',examples: ''},
        {title: '', type:"noun",meaning: '',examples: ''},
        {title: '', type:"noun",meaning: '',examples: ''},
        {title: '', type:"noun",meaning: '',examples: ''},
    ]},
