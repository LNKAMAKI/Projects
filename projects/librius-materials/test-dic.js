...
contents = [
    ...
    {title:'text-2-train-1', url:'html-logo.svg',subs:[
        {title: 'in a row', type:"expression",meaning: 'means that something occurs consecutively or successively without interruption',examples: ' It was the second day in a row in which the US military shot down an unidentified airborne object'},
    ...
    {title:'text-3-train-1', url:'html-logo.svg',subs:[
        ...
        {title: 'outbreak', type:"noun",meaning: 'a time when something suddenly begins, especially a disease or something else dangerous or unpleasant',examples: 'This sci-fi pseudo-realist explanation is mainly a vehicle for a zombie outbreak@the outbreak of war'},
        {title: 'protrude', type:"noun",meaning: '',examples: ''},
        {title: 'pileus caps', type:"noun",meaning: '',examples: ''},
        {title: 'uncanny', type:"noun",meaning: '',examples: ''},
        {title: 'resemblance', type:"noun",meaning: '',examples: ''},
        {title: 'loot', type:"noun",meaning: '',examples: ''},
        {title: 'warfare', type:"noun",meaning: '',examples: ''},
        {title: 'calloused', type:"noun",meaning: '',examples: ''},
        {title: 'portrayal', type:"noun",meaning: '',examples: ''},
        {title: 'thrust', type:"noun",meaning: '',examples: ''},
        {title: 'warp', type:"noun",meaning: '',examples: ''},
        {title: 'enthralling', type:"noun",meaning: '',examples: ''},
        {title: 'reversed', type:"noun",meaning: '',examples: ''},
        {title: 'pacing', type:"noun",meaning: '',examples: ''},
        {title: 'prelude', type:"noun",meaning: '',examples: ''},
        {title: 'dreadful', type:"noun",meaning: '',examples: ''},
        {title: 'hubris', type:"noun",meaning: '',examples: ''},
        {title: '', type:"noun",meaning: '',examples: ''},
        {title: '', type:"noun",meaning: '',examples: ''},
        {title: '', type:"noun",meaning: '',examples: ''},
        {title: '', type:"noun",meaning: '',examples: ''},
