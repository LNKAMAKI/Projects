...
'hymn for the weekend','higher than higher','hey soul sister','hurt','happy now','hello','how did it come to this','hold on','hear me now', 'higher power', 'high hopes', 'hold up a light', 'human',
'iridescent','in pieces', 'it\'s my life','i\'d wait for life','if it\'s not love','into the wild', 'i\'m yours', 'in the end',
'julie',
'kidz',
'like i never loved you at all','lost in the echo','luka','like a stone','lovelife','leave out all the rest', 'last kiss', 'love love', 'lucid dream', 'lovers in japan','losing my religion',
...
'what you believe in','wake me up','waiting for the end','what i\'ve done','where\'s the love?','what\'s love','when we were young','wrecked','what do you want from me','wake me up when september ends','warning sign', 'wonderful world', 'wherever you will go', 'when can i see you again', 
