...
window.addEventListener('keydown', (event)=> {
    ...
    //console.log(' ')
        ...
        // Resolvendo o trem dos parênteses
        degs = []
        parents = 0
...
expression = ['(','(','9','+','3',')','x','(','2','-','1',')',')','x','2']
expression = ['(', '10', '-', '(', '4', '-', '2', ')', ')', 'x', '5','+','(','6','-','(','5','-','2',')',')']
console.log(2)
console.log(2)
console.log(2)
console.log(2)
...
//console.log(' ')
    ...
    for (e = 0; e < expression.length; e++) {
        ...
        if (expression[e] == '(') {
           ...
           if (expression.length != 0 && falta == false) {
               anstxt = txt
               console.warn('fazer conta recebe:',anstxt)
            fazerConta(anstxt) 
            position = 0    
           ansd = true
...
function fazerConta(anterior) {
    ...
    console.log('bora fazer a conta')
        if(0 == 0) {// falta == false
            ...
            if (expression[e] == '(') {
               ...
               if (expression.length != 0 && falta == false) {
                ...
                for (b = 0; b < expression.length; b++) {
                   ...
                   anstxt = txt
                   console.warn('fazer conta de ',anstxt)
                console.log('igual a: ',fazerConta(anstxt)) 
                position = 0    
               ansd = true
