...
meaning: 'to give things to a number of people/to serve food/if someone dishes out something such as criticism or punishment, they criticize or punish someone severely/if you can\'t take it, don\'t dish it out: If you don\'t like being criticized, don\'t do it to other people', 
examples: 'Some doctors are dishing out drugs their patients do not need/He was dishing out a chicken stew/He’s always ready to dish out criticism'},
...
{word: 'wreck',type: 'verb transitive/noun', meaning: 'to severely damage or destroy a vehicle or building/to damage something such as a plan or a relationship so badly that it no longer exists/naufragar/A ship, car, plane, etc. that has been very badly damaged in an accident/INFORMAL: A person who is in a bad physical or mental condition',
...
examples: 'I really hate to pay this toll(from Helloween)/Toll charges/Death toll/The mounting toll of failed businesses'},
...
examples: ''},
{word: 'rally',type: 'verb/noun', 
meaning: 'protest, a public meeting of a large group of people, especially supporters of a particular opinion/to (cause to) come together in order to provide support or make a shared effort/improvement, improve', 
examples: '5,000 people held an anti-nuclear rally/The general rallied his forces to defend the town/The team played badly in the first half of the game but rallied in the second*The nurse said my mother had rallied after a poor night'},
...
{word: 'sore',type: 'adjective/noun/adverb', 
meaning: 'painful and uncomfortable(area) because of injury, infection, or too much use/INFORMAL: angry because you feel you have been unfairly treated/extremely, severely', 
examples: 'I\'ve got a sore back*The poor dog\'s back was covered with sores/He accused me of being a sore loser (= someone who does not accept defeat well)/"they were sore afraid'},
...
{word: 'tinge',type: 'verb/noun', 
meaning: 'a very slight amount of a color or of a feeling/to add a slight amount of color or a quality to something', 
examples: 'His hair is starting to show tinges of gray*I felt a tinge of regret that I hadn\'t accepted her offer/he sunset tinged the sky red'},
{word: 'endeavor',type: 'verb/noun', 
...
meaning: 'legal responsible for something/something or someone that causes you a lot of trouble, often when that thing or person should be helping you/the amount of money that a person or organization owes', 
examples: 'He denies any liability for the damage caused/After a certain age, a car\'s just a liability/He listed liabilities of more than $3 million*he company will also have to show that it has a liability of $600'},
...
meaning: 'speed and skill of the hand when performing tricks/skilful hiding of the truth in order to win an advantage', 
examples: 'Most of these conjuring tricks depend on sleight of hand/this is financial sleight of hand of the worst sort'},
...
meaning: 'to say something or to make a sound with your voice/complete or extreme', 
examples: 'She didn\'t utter a word through the whole meeting/utter confusion, misery, chaos, nonsense, rubbish, drivel'},
{word: 'dump',type: 'verb/noun', 
meaning: 'to put down or drop something in a careless way/to get rid of something unwanted, especially by leaving it in a place where it is not allowed to be:/to sell unwanted goods very cheaply, usually in other countries/to suddenly end a romantic relationship you have been having with someone/a place where people are allowed to leave their rubbish/INFORMAL: a very unpleasant and unattractive place', 
examples: 'He came in with four shopping bags and dumped them on the table/Toxic chemicals continue to be dumped into the river/They accused the West of dumping out-of-date medicines on Third World countries/She\'s got dumped by her boyfriend not so long ago//I\'m sure you\'d rather stay on this dump than buying your own house'},
...
meaning: 'to look around a place secretly, in order to discover things or find out information about someone or something/to try to find out about other people\'s private lives', 
examples: 'If you came here to snoop around, you\'d better keep going/Clara\'s husband is snooping on her because he thinks she is seeing another man'},
...
meaning: 'to make something known publicly, or to show something that was hidden/to give secret, private, or personal information because you must do so for financial, insurance, or legal reasons', 
