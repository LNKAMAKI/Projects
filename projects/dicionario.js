...
examples: 'The warden went around tearing down pictures and posters hanging up in prisoners\' cells/I can\'t believe they haven\'t torn that old building down yet'},
{word: 'vacancy',type: 'noun', 
meaning: 'vaga/a job that is available for someone to do/a room in a hotel that is available for someone to stay in/FORMAL: Lack of intelligence or interest', 
examples: '/We have several vacancies to fill in the Sales Department*Vacancy for: There are always plenty of vacancies for bar staff/We have no vacancies at all during July'},
{word: 'bid',type: 'verb', 
...
examples: 'Bid for: Two people were bidding against each other for the mirror*Bid something for something: They bid £300 for the painting/Bid for: Several contractors bid for the job'},
...
examples: '/He spent hours sifting through all the documents relating to the case*Sift every grain of information until you find the answer/They sifted through the rubble, searching for signs of life'},
{word: 'deceit',type: 'noun', 
meaning: 'enganação, fraude/dishonest behaviour that is intended to trick someone', 
examples: '/The whole relationship was based on lies and deceit'},
{word: 'unwind',type: 'verb', 
meaning: 'INFORMAL: to begin to relax after you have been working hard or feeling nervous/desenrolar', 
examples: 'I need to sit down and unwind for half an hour/She slowly unwound the scarf from around her neck'},
...
examples: '/Don\'t worry, we\'ve got stacks of time//Once the last few people had left the hall, the caretaker began stacking (up) the chairs/I got a job stacking shelves in a supermarket'},
