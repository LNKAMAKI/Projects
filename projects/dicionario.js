...
{word: 'finicky',type: 'adjective', meaning: 'fussy, difficult to please, meticulous in taste or standards-, showing or requiring great attention to detail', 
examples: 'finicky eater(picky eater)*Repairing watches must be a very finicky job'},
...
examples: 'The company claims (that) it is not responsible for the pollution in the river*She made a bold claim about the existence of extraterrestrial life*The politician\'s claim that taxes would decrease under his administration was met with doubt by economists'},
...
examples: 'And the blood\'s run stale(from Imagine Dragons)_Get, go stale: Wrap the bread up well or it’ll go stale_Stale air*Stale cigarette smoke_Stale news, jokes, ideas_ Get, go stale: He was getting stale and wanted a new job'},
...
{word: 'assemble',type: 'verb', 
meaning: 'montar/juntar/agrupar', 
examples: 'She assembled the ingredients for the recipe*everyone is supposed to leave the building and assemble in the schoolyard*The manager assembled the team for a meeting'},
{word: 'swift',type: 'adjective', 
meaning: 'happening or moving quickly or within a short time, especially in a smooth and easy way', 
examples: 'We must be swift as the coursing river (Mualan)*The gazelle is one of the swiftest and most graceful of animals'},
{word: 'demote',type: 'verb transitive', 
meaning: 'to lower somone in rank or position', 
examples: 'The captain was demoted to sergeant for failing to fulfil his duties*Her manager demoted her from her job as a supervisor*The department is planning to demote some managers as a cost-saving measure'},
{word: 'wrinkle',type: 'noun', 
meaning: 'ruga_crease(a small line or fold in cloth)_a problem, usually a small one', 
examples: 'As he smiled, deep wrinkles appeared around his eyes_She smoothed out the wrinkles in her dress before the party_There\'s a wrinkle in our plan that we need to address before moving forward'},
{word: 'vile',type: 'adjective', 
meaning: 'extremely unpleasent, morally reprehensible or wicked', 
examples: 'His vile behavior towards his colleagues made him very unpopular in the office*He responded with the vilest language imaginable'},
{word: 'worthwhile',type: 'adjective', 
meaning: 'worth the time/effort/or resources', 
examples: ''},
{word: 'understated',type: 'adjective', 
meaning: 'low-key, restrained, not trying to attract attention or impress people', 
examples: 'He\'s very elegant, in an understated way*His performance was powerful because of its understated delivery*The movie\'s emotional impact came from its understated storytelling'},
{word: 'flatter',type: 'verb transitive', 
meaning: 'lisonjear/to praise someone in order to make them feel attractive or important, sometimes in a way that is not sincere', 
examples: 'He flattered his boss to get a promotion*She flattered him into believing he was the best candidate for the job'},
{word: 'flustered',type: '', 
meaning: '', 
examples: ''},
{word: 'stakeout',type: 'noun', 
meaning: 'tocaia', 
examples: ''},{word: '',type: '', 
meaning: '', 
examples: ''},{word: '',type: '', 
