...
{word: 'strip',type: 'verb/noun', meaning: 'to remove, pull, or tear the covering or outer layer from something_tira_to remove clothing from', 
...
{word: 'in a row', type:"idiom",meaning: 'means that something occurs consecutively or successively without interruption',examples: ' It was the second day in a row in which the US military shot down an unidentified airborne object'},
        ...
        {word: 'work out', type:"transitive phrasal verb",meaning: 'to solve a problem, figure out an answer, or find a solution to a challenging situation',examples: 'ChatGPT is often highly impressive at working out what information a question is really after'},
        ...
        {word: 'nonsensical', type:"adjective",meaning: 'preposterous, unreasonable, senseless; lacking sense, logic, or meaning',examples: 'ChatGPT will sometimes write plausible-sounding but incorrect or nonsensical answers'},
        ...
        {word: 'put down', type:"phrasal verb",meaning: 'attribute something as the cause of something else_disapprove or criticize_',examples: 'it can also give long-winded replies, a problem its developers put down to trainers preferring longe answers that loook more comprehensive_She felt hurt when her peers put her down for her ideas'},
{word: '',type: '', 
meaning: '', 
examples: ''},
{word: 'subdue',type: '', 
