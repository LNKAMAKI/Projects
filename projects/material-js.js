...
// Materiais Array
contents = [
    {title:'HTML', url:'html-logo.svg',subs:[{title:'Estrutura básica e tags HTML',url:'../materiais/introducao-html.html'},{title:'Quebras de linha e símbolos',url:'../materiais/br,símbolos.html'},{title:'Imagens',url:'../materiais/imagens.html'},{title:'Favicon e links',url:'../materiais/favicon-links.html'},{title:'Formatações de texto',url:'../materiais/tipostexto.html'}]},
